...
> 融合《渊海子平》《三命通会》《紫微斗数全书》《穷通宝鉴》《子平真诠》《滴天髓》《协纪辨方书》《神峰通考》《兰台妙选》《三车一览》《李虚中命书》《黄帝内经》《称骨歌》等**数十本**经典命理古籍的深度测算工具。
...
| 书籍 | 用途 |
|------|------|
| 《称骨歌》 | 袁天罡称骨算命（年/月/日/时骨重表） |
| 《神相全编》 | 命相对照、性格寄语 |
| 《柳庄神相》 | 断语措辞、总评生成 |

---

合计 **36 部** 经典古籍，全部落实到代码模块：

- 排盘内核 → `src/bazi-core.js`
- 真太阳时 / 神煞 / 紫微 / 渲染 → `src/script.js`
